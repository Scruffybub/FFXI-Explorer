...
app.whenReady().then(async () => {
  ...
  const errors = logs.filter(l =>
    /UVFIX|UVSTRADDLE|UVALPHA|ALPHAHIST|BLENDHIST|MUSIC|WEATHER|ORPHANSRC|MZBMATCH|MMBNAMES|BLEND|NANSCAN|CUTOUT|Collision|Walk|unreferenced|ORPHANS|PICK|CENSUS|program not valid|VALIDATE_STATUS|shader|THREE\.\w+Error|Warning:/i.test(l),
  )
